...
var AddProductComponent = /** @class */ (function () {
    function AddProductComponent(_fb, formBuilder, service, route) {
    ...
    AddProductComponent.prototype.initlanguage = function () {
        ...
        return this._fb.group({
            varianceKey: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            varianceValue: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]
        });
    };
    AddProductComponent.prototype.addLanguage = function (i) {
        var test = this.myGroup.get('variance');
        ...
        if (this.enabDisable.indexOf('color') != -1) {
            this.selectVal = true;
        }
        if (this.enabDisable.indexOf('size') != -1) {
            this.Size = true;
        }
        if (this.enabDisable.indexOf('material') != -1) {
            this.Material = true;
        }
        if (this.count == 3) {
    ...
    AddProductComponent.prototype.removeLanguage = function (i) {
        ...
        var control = this.myForm.controls['languages'];
        console.log("remove at index", control);
        control.removeAt(i);
        this.count--;
        this.check = true;
        var temp = this.enabDisable.splice(i, 1);
        if (temp[0] == 'color') {
    ...
    AddProductComponent.prototype.saveVariants = function (val) {
        ...
        this.service.postApi('vendor/combination', temp, 0).subscribe(function (response) {
            if (response['statusCode'] == 200) {
                ...
                if (temp['push'][0]['varianceKey'] == '' && temp['push'][0]['varianceValue'] == '') {
                    _this.dataLoop.length = 0;
                }
    ...
    AddProductComponent.prototype.disableEle = function (deviceValue, e) {
        console.log(deviceValue);
        if (this.enabDisable.indexOf(deviceValue) != -1) {
            if (deviceValue == 'color') {
                this.selectVal = true;
            }
            if (deviceValue == 'size') {
                this.Size = true;
            }
            if (deviceValue == 'material') {
                this.Material = true;
            }
        }
        else {
            this.enabDisable[e] = deviceValue;
        }
        if (this.enabDisable.length == 3) {
            this.selectVal = true;
            this.Size = true;
            this.Material = true;
        }
        console.log(this.enabDisable);
    };
    AddProductComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], src_app_Services_provider_service__WEBPACK_IMPORTED_MODULE_1__["DataService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], AddProductComponent);
...
var AllproductsComponent = /** @class */ (function () {
    function AllproductsComponent(service, route) {
        this.service = service;
        this.route = route;
        this.rows = [];
        this.selected = [];
    ...
    AllproductsComponent.prototype.ngOnInit = function () {
        this.service.setTitle('All Product');
        // this.getBrandList()
        // this.getCategory()
    ...
    AllproductsComponent.prototype.getproductList = function () {
        ...
        this.service.getApi('admin/getProductList', 1).subscribe(function (response) {
            console.log("response-======>>>", response);
            if (response['statusCode'] == 200) {
                _this.getProductCount = response['result']['getProduct'];
                // console.log(this.getbrandcount.length)
                _this.getProductCount = _this.getProductCount.length;
                _this.getbrandcount = response['result'].getBrandofVendor.length;
                _this.getCategoryCount = response['result'].getcategoryofVendor.length;
                _this.apiData = response['result'].getProduct;
            }
            else {
                // console.log(response['result'])
                _this.getProductCount = 0;
                _this.apiData = false;
                // console.log('this.apidtaa',this.apiData)
                _this.service.showError('NOT FOUND');
                // this.service.showError('Invalid email or password.')
            }
        }, function (error) {
    ...
    AllproductsComponent.prototype.editProduct = function (productId) {
        console.log(productId);
        this.route.navigate(['editProduct/' + productId]);
        this.service.setTitle('Edit Product');
    };
...
/***/ "./src/app/Components/constant/app.constant.ts":
/*!*****************************************************!*\
  !*** ./src/app/Components/constant/app.constant.ts ***!
  \*****************************************************/
...
module.exports = "<div id=\"wrapper\">\n  <!--Header Start Here-->\n  <app-header></app-header>\n  <!--Header End Here-->\n  <!-- Sidebar Start Here-->\n  <app-side-bar></app-side-bar>\n  <!-- Sidebar end Here-->\n  <!--Create New Offer Products Content Section Start Here-->\n  <div id=\"page-content-wrapper\">\n    <div class=\"dashboardConbx\">\n      <form class=\"form\" [formGroup]='Form'>\n        <div class=\"addproductheadingrow\">\n          <h3>Create Offer</h3>\n          <div class=\"addproheadingbtn\">\n            <button type=\"button\" class=\"btn btn-primary addprobtn cancel\">Cancel</button>\n            <button type=\"button\" class=\"btn btn-primary addprobtn\" [disabled]=\"!Form.valid\" (click)=\"saveOffer(Form.value)\">Save</button>\n          </div>\n        </div>\n        <div class=\"productsviewrow create_new_offer\">\n          <div class=\"row eqWrap equalHMWrap clearfix\">\n            <!--Text Editor Section Start Here-->\n            <div class=\"col-lg-5 texteditorwrap\">\n              <div class=\"form-group\">\n                <label>Title</label>\n                <input class=\"form-control\" type=\"text\" placeholder=\"Black Typography Top\" [formControl]=\"Form.controls['title']\" />\n                <p *ngIf=\"Form.controls['title'].hasError('required') && Form.controls['title'].dirty\" style=\"color:red;font-size:14px;\">*required</p>\n              </div>\n              <div class=\"form-group\">\n                <label>Description</label>\n                <ckeditor [(ngModel)]=\"ckeditorContent\" [formControl]=\"Form.controls['description']\" ngDefaultControl>\n                  <ckbutton [name]=\"'saveButton'\" [command]=\"'saveCmd'\" (click)=\"save($event)\" [icon]=\"'save.png'\"\n                    [label]=\"'Save Document'\" [toolbar]=\"'clipboard,1'\">\n                  </ckbutton>\n                </ckeditor>\n                <p *ngIf=\"Form.controls['description'].hasError('required') && Form.controls['description'].dirty\"\n                  style=\"color:red;font-size:14px;\">*required</p>\n              </div>\n            </div>\n            <!--Text Editor Section End Here-->\n\n            <!--Image Upload Section Start Here-->\n            <div class=\"col-lg-7 fileuploadbox\">\n              <label>Product Images</label>\n              <div class=\"row clearfix\">\n                <div class=\"col-sm-5 pdr10wds\">\n                  <div class=\"uploadimgbx wd100\">\n                    <div class=\"fileinput fileinput-new\" data-provides=\"fileinput\">\n                      <div class=\"fileinput-preview thumbnail\" data-trigger=\"fileinput\"></div>\n                      <div> <span class=\"btn btn-default btn-file\">\n                          <input id=\"input-22\" type=\"file\" name=\"...\" accept=\".jpg,.gif,.png\" (change)='onFileChanged($event)'>\n                        </span> </div>\n                    </div>\n                  </div>\n                </div>\n                <div class=\"col-sm-7 pdlsunye\">\n                  <div class=\"uploadimgbx wd100_landsscape\">\n                    <div class=\"fileinput fileinput-new\" data-provides=\"fileinput\">\n                      <div class=\"fileinput-preview thumbnail\" data-trigger=\"fileinput\"></div>\n                      <div> <span class=\"btn btn-default btn-file\">\n                          <input id=\"input-22\" type=\"file\" name=\"...\" accept=\".jpg,.gif,.png\" (change)='onFileChanged($event)'>\n                        </span> </div>\n                    </div>\n                  </div>\n                  <div class=\"uploadimgbx wd100_landsscape\">\n                    <div class=\"fileinput fileinput-new\" data-provides=\"fileinput\">\n                      <div class=\"fileinput-preview thumbnail\" data-trigger=\"fileinput\"></div>\n                      <div> <span class=\"btn btn-default btn-file\">\n                          <input id=\"input-22\" type=\"file\" name=\"...\" accept=\".jpg,.gif,.png\" (change)='onFileChanged($event)'>\n                        </span> </div>\n                    </div>\n                  </div>\n                </div>\n              </div>\n\n            </div>\n            <!--Image Upload Section End Here-->\n          </div>\n        </div>\n\n        <div class=\"productsviewrow create_new_offer\">\n          <div class=\"row eqWrap equalHMWrap clearfix\">\n            <div class=\"col-lg-5 texteditorwrap\">\n              <!--Product Category Section Start Here-->\n              <div class=\"form-group\">\n                <label>Offer Type</label>\n                <select class=\"form-control\" [formControl]=\"Form.controls['offerType']\">\n                  <option selected value=\"percent\">%age</option>\n                  <option value=\"price\">price</option>\n                </select>\n                <!-- <p *ngIf=\"Form.controls['offerType'].hasError('required') && Form.controls['offerType'].dirty\"\n                style=\"color:red;font-size:14px;\">*required</p> -->\n              </div>\n              <div class=\"form-group\">\n                <label>Value</label>\n                <input class=\"form-control\" type=\"text\" placeholder=\"50\" [formControl]=\"Form.controls['value']\" />\n              </div>\n              <div class=\"form-group\">\n                <label>Minimum Requirement</label>\n                <select class=\"form-control\" [formControl]=\"Form.controls['minimumRequirement']\">\n                  <option value=\"NAN\">NAN</option>\n                </select>\n                <!-- <p *ngIf=\"Form.controls['minimumRequirementi'].hasError('required') && Form.controls['minimumRequirementi'].dirty\"\n                style=\"color:red;font-size:14px;\">*required</p> -->\n              </div>\n              <div class=\"form-group\">\n                <label>Applicable on</label>\n                <select class=\"form-control\" [formControl]=\"Form.controls['applicableType']\" (change)=\"applicable($event.target.value)\">\n                  <option value=1>Specific Product</option>\n                  <option value=0>Product Category</option>\n                </select>\n                <!-- <p *ngIf=\"Form.controls['applicableType'].hasError('required') && Form.controls['applicableType'].dirty\"\n                style=\"color:red;font-size:14px;\">*required</p> -->\n              </div>\n              <div>\n                <ng-multiselect-dropdown [placeholder]=\"'Select your category'\" [data]=\"productList\" [settings]=\"dropdownSettings\"\n                  [formControl]=\"Form.controls['applicableOn']\" ngDefaultControl>\n                </ng-multiselect-dropdown>\n                <!-- <p *ngIf=\"Form.controls['applicableOn'].hasError('required') && Form.controls['applicableOn'].dirty\"\n                  style=\"color:red;font-size:14px;\">*required</p> -->\n              </div>\n              <!--Product Category Section End Here-->\n            </div>\n\n\n            <!--Choose Date Section Start Here-->\n            <div class=\"col-lg-7 fileuploadbox\">\n              <div class=\"row clearfix\">\n                <div class=\"col-sm-6\">\n                  <label>Start Date</label>\n                  <!-- <form #myForm=\"ngForm\" novalidate> -->\n                  <my-date-picker name=\"mydate\" [options]=\"myDatePickerOptions\" [formControl]=\"Form.controls['StartDate']\"\n                    (dateChanged)=\"onDateChanged($event)\" required></my-date-picker>\n                  <!-- <p *ngIf=\"Form.controls['StartDate'].hasError('required') && Form.controls['StartDate'].dirty\" style=\"color:red;font-size:14px;\">*required</p> -->\n                  <!-- </form> -->\n                </div>\n                <div class=\"col-sm-6\">\n                  <label>End Date</label>\n                  <my-date-picker name=\"mydate\" [options]=\"myDatePickerOptions2\" [formControl]=\"Form.controls['EndDate']\"\n                    (dateChanged)=\"onDateChanged($event)\" required></my-date-picker>\n                </div>\n                <!-- <p *ngIf=\"Form.controls['EndDate'].hasError('required') && Form.controls['EndDate'].dirty\" style=\"color:red;font-size:14px;\">*required</p> -->\n              </div>\n\n            </div>\n            <!--Choose Date Section End Here-->\n          </div>\n        </div>\n      </form>\n    </div>\n  </div>\n  <!--Create New Offer Products End Here-->\n\n\n</div>"
...
var CreateOfferComponent = /** @class */ (function () {
    function CreateOfferComponent(service, formBuilder) {
        ...
        this.Form = this.formBuilder.group({
            ...
            offerType: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            ...
            applicableType: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            applicableOn: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            minimumRequirement: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
        });
    }
    ...
    CreateOfferComponent.prototype.getproductList = function () {
        var _this = this;
        this.service.getApi('admin/getProductList?lang=en', 1).subscribe(function (response) {
            // console.log("response-======>>>",response)
            if (response['statusCode'] == 200) {
                console.log(response);
                _this.productList = response['result'].getProduct;
    ...
    CreateOfferComponent.prototype.applicable = function (val) {
        var _this = this;
        console.log('variable', val);
        if (val == 0) {
            this.service.getApi('vendor/getVendorProductCategorylist?lang=en', 1).subscribe(function (response) {
                // console.log("response-======>>>",response)
                if (response['statusCode'] == 200) {
                    console.log(response);
                    _this.productList = response['result'];
                    _this.dropdownSettings = {
                        singleSelection: false,
                        idField: '_id',
    ...
    CreateOfferComponent.prototype.onFileChanged = function (evt) {
        var file = evt.target.files[0];
        if (file) {
            console.log('2222', file);
            var reader = new FileReader();
    ...
    CreateOfferComponent.prototype.handleReaderLoaded = function (e) {
        this.imageData.push('data:image/png;base64,' + btoa(e.target.result));
    };
    //save Offer
    CreateOfferComponent.prototype.saveOffer = function (val) {
        var _this = this;
        var a = [];
        for (var i in val.applicableOn) {
            a.push(val.applicableOn[i]._id);
        }
        var temp = {
            "userId": localStorage.getItem('token'),
            "offerName": val.title,
            "description": val.description,
            "offerImage": this.imageData,
            "offerType": val.offerType,
            "value": val.value,
            "applicableType": val.applicableType,
            "applicableOn": a,
            "startDate": new Date(val.StartDate.jsdate).toISOString(),
            "endDate": new Date(val.EndDate.jsdate).toISOString(),
            "lang": "en"
        };
        this.service.postApi('vendor/addVendoroffer', temp, 1).subscribe(function (response) {
            _this.service.spinnerShow();
            console.log("response-======>>>", response);
            if (response['statusCode'] == 200) {
                _this.service.showSuccess('Offer Added');
                _this.service.spinnerHide();
                _this.Form.reset();
            }
            else {
...
/***/ "./src/app/Components/create-vendor/create-vendor.component.css":
/*!**********************************************************************!*\
  !*** ./src/app/Components/create-vendor/create-vendor.component.css ***!
  \**********************************************************************/
/*! no static exports found */
...
/***/ "./src/app/Components/create-vendor/create-vendor.component.html":
/*!***********************************************************************!*\
  !*** ./src/app/Components/create-vendor/create-vendor.component.html ***!
  \***********************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"business_detailswrap vendor clearfix\">\n  <div class=\"businessrttopbg\"></div>\n  <div class=\"wakilogo\"></div>\n  <div class=\"businConbx\">\n    <form name=\"createVendorForm\" [formGroup]='createVendorForm' id=\"vendor\" data-parsley-validate class=\"form-horizontal form-label-left\">\n      <div class=\"businesstextrow\">\n        <h1>Create Vendor</h1>\n      </div>\n      <div class=\"sminfo\">Lorem ipsum dolor sit amet, consectetur adipisicing elit</div>\n      <div class=\"businessfrombx\">\n        <div class=\"form-group text-center\">\n          <div class=\"uploadimgbx\">\n            <div class=\"fileinput fileinput-new\" data-provides=\"fileinput\">\n              <div class=\"fileinput-preview thumbnail\" data-trigger=\"fileinput\"></div>\n              <div> <span class=\"btn btn-default btn-file\">\n                  <input id=\"input-22\" type=\"file\" name=\"...\"  (change)=\"changeListener($event)\" accept=\".jpg,.gif,.png\"\n                    [formControl]=\"createVendorForm.controls['profilePic']\" ngDefaultControl>\n                </span> </div>\n\n              </div>\n            </div>\n          </div>\n          <div class=\"form-group\">\n            <input class=\"form-control\" type=\"text\" placeholder=\"First Name\" [formControl]=\"createVendorForm.controls['firstName']\" />\n            <div *ngIf=\"createVendorForm.controls['firstName'].invalid && (createVendorForm.controls['firstName'].dirty || createVendorForm.controls['firstName'].touched)\">\n              <div *ngIf=\"createVendorForm.controls['firstName'].errors.required\" class=\"class alert-danger\">\n                First Name is required.\n              </div>\n            </div>\n          </div>\n          <div class=\"form-group\">\n            <input class=\"form-control\" type=\"text\" placeholder=\"Last Name\" [formControl]=\"createVendorForm.controls['lastName']\" />\n            <div *ngIf=\"createVendorForm.controls['lastName'].invalid && (createVendorForm.controls['lastName'].dirty || createVendorForm.controls['lastName'].touched)\">\n              <div *ngIf=\"createVendorForm.controls['lastName'].errors.required\" class=\"alert alert-danger\">\n                Last Name is required.\n              </div>\n            </div>\n          </div>\n          <div class=\"form-group\">\n            <input class=\"form-control\" type=\"text\" placeholder=\"Email Address\" [formControl]=\"createVendorForm.controls['email']\" />\n\n            <div *ngIf=\"createVendorForm.controls['email'].invalid && (createVendorForm.controls['email'].dirty || createVendorForm.controls['email'].touched)\">\n              <div *ngIf=\"createVendorForm.controls['email'].errors.required\" class=\"alert alert-danger\">Email is\n                required</div>\n              <div *ngIf=\"createVendorForm.controls['email'].errors.email\" class=\"alert alert-danger\">Email must be\n                a valid email address</div>\n            </div>\n          </div>\n          <div class=\"form-group\">\n\n\n            <div class=\"sales_year_choose\">\n              <select class=\"form-control select2\" [formControl]=\"createVendorForm.controls['prefix']\">\n                <option value=''>Select country code</option>\n                <option *ngFor=\"let country of codeArray\" [value]=\"country.code\">{{country.code}} ( {{country.country}}\n                  )</option>\n              </select>\n              <div *ngIf=\"createVendorForm.controls['prefix'].invalid  && (createVendorForm.controls['prefix'].dirty || createVendorForm.controls['prefix'].touched)\"\n                [ngClass]=\"'error'\">\n                <div *ngIf=\"createVendorForm.controls['prefix'].errors.required\" class=\"alert alert-danger\">\n                  Country Code is required.\n                </div>\n                <div *ngIf=\"createVendorForm.get('prefix').hasError('pattern')\" class=\"alert alert-danger\">\n                  Select Country code.\n                </div>\n              </div>\n            </div>\n          </div>\n\n          <div class=\"form-group\">\n            <input class=\"form-control\" type=\"text\" placeholder=\"Enter Your Phone Number\" [formControl]=\"createVendorForm.controls['phone']\" />\n            <div *ngIf=\"createVendorForm.controls['phone'].invalid  && (createVendorForm.controls['phone'].dirty || createVendorForm.controls['phone'].touched)\"\n              [ngClass]=\"'error'\">\n              <div *ngIf=\"createVendorForm.controls['phone'].errors.required\" class=\"alert alert-danger\">\n                Phone number is required.\n              </div>\n              <div *ngIf=\"createVendorForm.get('phone').hasError('pattern')\" class=\"alert alert-danger\">\n                It is not a valid mobile number.\n              </div>\n            </div>\n\n          </div>\n          <div class=\"form-group\">\n            <input class=\"form-control\"  #address id=\"address\" type=\"text\" placeholder=\"Address\" [formControl]=\"createVendorForm.controls['address']\" />\n            <div *ngIf=\"createVendorForm.controls['address'].invalid  && (createVendorForm.controls['address'].dirty || createVendorForm.controls['address'].touched)\"\n              [ngClass]=\"'error'\">\n              <div *ngIf=\"createVendorForm.controls['address'].errors.required\" class=\"alert alert-danger\">\n                Address is required.\n              </div>\n            </div>\n          </div>\n          <div class=\"form-group\">\n            <div id=\"map\"></div>\n          </div>\n          <div class=\"form-group\">\n            <div class=\"sales_year_choose\">\n              <select class=\"form-control\" [formControl]=\"createVendorForm.controls['storeType']\">\n                <option value=\"\" selected>Select Store Type</option>\n                <option value=\"Physical Store\">Physical Store</option>\n                <option value=\"Virtual Store\">Virtual store</option>\n              </select>\n            </div>\n          </div>\n          <div class=\"form-group\">\n            <button type=\"submit\" class=\"btn btn-primary businessbtn\" [disabled]=\"!createVendorForm.valid\" (click)=createVendor(createVendorForm.value)>Submit</button>\n          </div>\n        </div>\n    </form>\n  </div>\n</div>"

/***/ }),

/***/ "./src/app/Components/create-vendor/create-vendor.component.ts":
/*!*********************************************************************!*\
  !*** ./src/app/Components/create-vendor/create-vendor.component.ts ***!
  \*********************************************************************/
...
var CreateVendorComponent = /** @class */ (function () {
    function CreateVendorComponent(formBuilder, service, route) {
        this.formBuilder = formBuilder;
        this.service = service;
        this.route = route;
        this.createVendorForm = formBuilder.group({
            ...
            phone: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].pattern('[6-9]\\d{9}')]],
            address: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            profilePic: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            storeType: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
    ...
    CreateVendorComponent.prototype.ngOnInit = function () {
        ...
        $('.sales_year_choose select.select').each(function () {
            ...
            $(this)
                ...
                .change(function () {
                this.val = $('option:selected', this).text();
    ...
    CreateVendorComponent.prototype.createVendor = function (val) {
        ...
        this.service.getLatApi(val.address).subscribe(function (response1) {
            ...
            var sentData = {
                ...
                lat: latitude,
                countryCode: val.prefix,
                lng: longitude,
                lang: 'en',
                status: 'inactive'
            };
            // })
            // console.log("2222",sentData)
            // return
            // console.log("WWWWWWWW", this.sentData)
            _this.service.postApi('admin/createVendor', sentData, 0).subscribe(function (response) {
                _this.service.spinnerShow();
                _this.responseData = response;
                console.log(response);
                ...
                else if (_this.responseData['statusCode'] == 400 || _this.responseData['statusCode'] == 401) {
                    // this.route.navigate(['/createvendor']);
                    _this.service.showError(response['statusMessage']);
                }
            }, function (error) {
                console.log('error occur', error);
                _this.service.showBug("");
    ...
    //
    // onSelectCountry() {
    //   console.log('selected country => ' + this.createVendorForm.controls['country'].value)
    //   let selectedCountry = this.createVendorForm.controls['country'].value
    ...
    // }
    CreateVendorComponent.prototype.getCountryCodesList = function () {
        var _this = this;
    ...
    CreateVendorComponent.prototype.reset = function () {
        this.createVendorForm.reset();
    };
    CreateVendorComponent.prototype.Cancel = function () {
        this.createVendorForm.reset();
    ...
    CreateVendorComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-create-vendor',
            template: __webpack_require__(/*! ./create-vendor.component.html */ "./src/app/Components/create-vendor/create-vendor.component.html"),
            styles: [__webpack_require__(/*! ./create-vendor.component.css */ "./src/app/Components/create-vendor/create-vendor.component.css")]
        }),
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], src_app_Services_provider_service__WEBPACK_IMPORTED_MODULE_2__["DataService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
...
module.exports = "<div id=\"wrapper\">\n  <!--Header Start Here-->\n  <app-header></app-header>\n  <!--Header End Here-->\n\n  <!-- Sidebar Start Here-->\n  <app-side-bar></app-side-bar>\n\n  <div id=\"page-content-wrapper\">\n    <form [formGroup]='myGroup' (ngSubmit)=\"onSubmit()\">\n      <div class=\"dashboardConbx\">\n        <div class=\"addproductheadingrow\">\n          <h3>Edit your product</h3>\n          <div class=\"addproheadingbtn\">\n            <button type=\"button\" class=\"btn btn-primary addprobtn cancel\">Cancel</button>\n            <button (click)=\"saveProduct(myGroup.value)\" type=\"button\" class=\"btn btn-primary addprobtn\">Save</button>\n          </div>\n        </div>\n        <div class=\"productsviewrow\">\n          <div class=\"row eqWrap equalHMWrap clearfix\">\n            <!--Text Editor Section Start Here-->\n            <div class=\"col-sm-5 texteditorwrap\">\n              <div class=\"form-group\">\n                <label>Title</label>\n                <input class=\"form-control\" [formControl]=\"myGroup.controls['title']\" type=\"text\" placeholder=\"Product Name Here\" />\n              </div>\n              <div class=\"form-group\">\n                <label>Description</label>\n                <div class=\"texteditorbox\"><img class=\"img-responsive\" width=\"606\" height=\"255\" />\n\n                  <ckeditor [(ngModel)]=\"ckeditorContent\" [formControl]=\"myGroup.controls['description']\"\n                    ngDefaultControl>\n                    <ckbutton [name]=\"'saveButton'\" [command]=\"'saveCmd'\" (click)=\"save($event)\" [icon]=\"'save.png'\"\n                      [label]=\"'Save Document'\" [toolbar]=\"'clipboard,1'\">\n                    </ckbutton>\n                  </ckeditor>\n\n                </div>\n              </div>\n            </div>\n            <!--Text Editor Section End Here-->\n\n            <!--Image Upload Section Start Here-->\n            <div class=\"col-sm-7 fileuploadbox\">\n              <label>Product Images</label>\n              <!-- <input type=\"file\" (change)='onFileChanged($event)' accept=\"image/jpeg,image/jpg,image/png\"> -->\n              <div class=\"uploadimgbx\" *ngFor=\"let item of myGroup.get('imageArray').value; let i = index;\">\n                <!-- {{item}} -->\n                <div class=\"fileinput fileinput-new\" id='fImage' data-provides=\"fileinput\">\n                  <div class=\"fileinput-preview thumbnail\" data-trigger=\"fileinput\">\n                    <img src={{item}} />\n                  </div>\n                  <div>\n                    <span class=\"btn btn-default btn-file\">\n                      <input id=\"input-22\" type=\"file\" name=\"...\" (change)='onFileChanged($event)' accept=\".jpg,.gif,.png\"\n                        [formControl]=\"myGroup.controls['image1']\">\n                    </span>\n                    <a class=\"closebox\" style=\"cursor:pointer\" (click)=\"removeImage(i)\">X</a>\n                  </div>\n                </div>\n              </div>\n            </div>\n            <!--Image Upload Section End Here-->\n          </div>\n        </div>\n        <div class=\"row productcategorywrap clearfix\">\n          <div class=\"col-sm-5 padwd10\">\n            <!--Product Category Section Start Here-->\n            <div class=\"productCategorybox\">\n              <div class=\"form-group\">\n                <label>Product Category</label>\n                <!-- {{myGroup.controls['productcategory'].value}} -->\n                <select class=\"form-control\" (change)=\"getCatgory($event.target.value)\" [formControl]=\"myGroup.controls['productcategory']\"\n                  ngDefaultControl>\n\n                  <option selected value=\"categoryId._id\" disabled>{{ categoryId?.categoryName}}</option>\n                  <option *ngFor=\"let c of category\" [value]=\"c._id\">{{c?.categoryName}}</option>\n                </select>\n              </div>\n              <div class=\"form-group\">\n                <label>Product Subcategory</label>\n                <select class=\"form-control\" (change)=\"SubCatorydata($event.target.value)\" [formControl]=\"myGroup.controls['productsubcategory']\"\n                  ngDefaultControl>\n                  <option selected disabled value=\"productsubcategory._id\">{{ productsubcategory?.subCategoryName}}</option>\n                  <option *ngFor=\"let c of getSubCatorydata\" [value]=\"c._id\">{{c.subCategoryName}}</option>\n                </select>\n              </div>\n              <div class=\"form-group\">\n                <label>Product Type</label>\n                <select class=\"form-control\" (change)=\"getProductCategoryId($event.target.value)\" [formControl]=\"myGroup.controls['producttype']\"\n                  ngDefaultControl>\n                  <option selected disabled value=\"producttype._id\">{{producttype?.productcategoryName}}</option>\n                  <option *ngFor=\"let c of productCategoryname\" [value]=\"c._id\">{{c.productcategoryName}}</option>\n                </select>\n              </div>\n              <div class=\"form-group\">\n                <label>Product Brand</label>\n                <select class=\"form-control\" [formControl]=\"myGroup.controls['productbrand']\" ngDefaultControl>\n                  <option selected disabled value=\"branddata._id\">{{branddata?.brandName}}</option>\n                  <option *ngFor=\"let c of getBrandId\" [value]=\"c._id\">{{c.brandName}}</option>\n                </select>\n              </div>\n              <!--  <div class=\"form-group mybrand clearfix\">\n              <form [formGroup]='formgroup'>\n                <input type=\"text\" placeholder=\"My Brand\" [formControl]=\"formgroup.controls['brand']\" />\n                <button type=\"submit\" (click)=\"addBrand(formgroup.value)\"><i class=\"fa fa-check\" aria-hidden=\"true\"></i></button>\n              </form>\n            </div> -->\n              <div class=\"form-group clearfix\">\n                <label>Product Tags</label>\n                <tag-input [(ngModel)]='itemsAsObjects' [placeholder]=\"'Enter a Tags'\" [onTextChangeDebounce]=\"500\"\n                  [formControl]=\"myGroup.controls['searchtag']\"></tag-input>\n                <!-- <tag-input [ngModel]=\"itemsAsObjects\" ></tag-input> -->\n              </div>\n            </div>\n            <!--Product Category Section End Here-->\n\n            <!--Modify Variants Table Section Start Here-->\n            <div class=\"modify_variants\">\n              <h4>Modify Variants</h4>\n              <table class=\"table\">\n                <thead>\n                  <tr>\n                    <th align=\"left\" valign=\"middle\">Variant</th>\n                    <th>Price</th>\n                    <th>SKU</th>\n                    <th>Inventory</th>\n                    <th>Images</th>\n                  </tr>\n                </thead>\n                <tbody>\n                  <tr formArrayName=\"variance\" *ngFor=\"let item of myGroup.get('variance').controls; let i = index;\">\n                    <ng-container [formGroupName]=\"i\">\n                      <td><span class=\"checkboxbx\">\n                          <input type=\"checkbox\" id={{i}} formControlName='checked' />\n                          <label for={{i}}>&nbsp;</label>\n                        </span>\n                        <span class=\"sizenm\">{{item?.controls.size.value}}</span>&nbsp;\n                        <span class=\"sizenm\">{{item?.controls.material.value}}</span>&nbsp;\n                        <span class=\"colornm\">{{item?.controls.color.value}}</span>&nbsp;\n                      </td>\n                      <td><input class=\"form-control\" type=\"text\" placeholder=\"230\" formControlName=\"price\" /></td>\n                      <td><input class=\"form-control\" type=\"text\" placeholder=\"BHJ89\" formControlName=\"SKU\" /></td>\n                      <td><input class=\"form-control\" type=\"text\" placeholder=\"1234\" formControlName=\"quantity\" /></td>\n                      <td> <input id=\"input-22\" type=\"file\" name=\"...\" (change)='readThis($event, i)' accept=\".jpg,.gif,.png\"\n                          ngDefaultControl multiple></td>\n                    </ng-container>\n                  </tr>\n                </tbody>\n              </table>\n            </div>\n            <!--Modify Variants Table Section End Here-->\n\n          </div>\n          <div class=\"col-sm-7 padwd10\">\n            <div class=\"row clearfix\">\n              <!--Selling Price Section Start Here-->\n              <div class=\"col-sm-6 pdrightwd10\">\n                <div class=\"productCategorybox\">\n                  <div class=\"form-group\">\n                    <label>Selling Price</label>\n                    <input class=\"form-control\" type=\"text\" placeholder=\"499\" [formControl]=\"myGroup.controls['sellingprice']\" />\n                  </div>\n                  <div class=\"form-group\">\n                    <label>Cost/Item</label>\n                    <input class=\"form-control\" type=\"text\" placeholder=\"399\" [formControl]=\"myGroup.controls['costprice']\" />\n                  </div>\n                  <div class=\"form-group\">\n                    <label>Item Weight</label>\n                    <input class=\"form-control\" type=\"text\" placeholder=\"0.5\" [formControl]=\"myGroup.controls['itemweight']\" />\n                  </div>\n                </div>\n                <!--Selling Price Section End Here-->\n              </div>\n              <!--Inventory Section Start Here-->\n              <div class=\"col-sm-6 pdleftwd10\">\n                <div class=\"productCategorybox\">\n                  <div class=\"form-group\">\n                    <label>Inventory SKU</label>\n                    <input class=\"form-control\" type=\"text\" placeholder=\"BUI\" [formControl]=\"myGroup.controls['InventorySKU']\" />\n                  </div>\n                  <div class=\"form-group\">\n                    <label>Quantity</label>\n                    <input class=\"form-control\" type=\"text\" placeholder=\"50\" [formControl]=\"myGroup.controls['quantity']\" />\n                  </div>\n                  <div class=\"form-group\">\n                    <label>Product Type</label>\n                    <select class=\"form-control\" [formControl]=\"myGroup.controls['trialPack']\">\n                      <option value=\"volvo\">Avaiable for try</option>\n                    </select>\n                  </div>\n                </div>\n              </div>\n              <!--Inventory Section End Here-->\n            </div>\n\n            <!--Variants Section Start Here-->\n            <!-- <div class=\"row clearfix\" hidden=true>\n              <div class=\"col-sm-12\">\n                <div class=\"productCategorybox\">\n                  <div class=\"variants\">\n                    <h4>Variants</h4>\n                    <div class=\"sminfo\">Swimming hundreds of feet beneath the ocean’s surface in many parts of the\n                      world\n                      are prolific aey construct one or more spacious houses” that can exceed three feet in length.\n                    </div>\n                    <div class=\"variantsoption\">\n                      <div class=\"form-group\">\n                        <div class=\"row clearfix\">\n                          <div class=\"col-sm-3\">\n                            <label>Option name</label>\n                            <input class=\"form-control\" type=\"text\" placeholder=\"Size\" />\n                          </div>\n                          <div class=\"col-sm-6\">\n                            <label>Option Values</label>\n                            <input class=\"form-control\" type=\"text\" placeholder=\"XS\" />\n                          </div>\n                          <div class=\"col-sm-3\">\n                            <label>&nbsp;</label>\n                            <button type=\"button\" class=\"btn btn-primary removebtn\">Remove</button>\n                          </div>\n                        </div>\n                      </div>\n                      <div class=\"form-group\">\n                        <div class=\"row clearfix\">\n                          <div class=\"col-sm-3\">\n                            <input class=\"form-control\" type=\"text\" placeholder=\"Color\" />\n                          </div>\n                          <div class=\"col-sm-6\">\n                            <input class=\"form-control\" type=\"text\" placeholder=\"Red\" />\n                          </div>\n                          <div class=\"col-sm-3\">\n                            <button type=\"button\" class=\"btn btn-primary removebtn addoption\">Add Option</button>\n                          </div>\n                        </div>\n                      </div>\n                    </div>\n                  </div>\n                </div>\n              </div>\n            </div> -->\n            <!--Variants Section End Here-->\n\n          </div>\n        </div>\n      </div>\n    </form>\n  </div>\n  <!-- </form> -->\n  <!--Add Products Section End Here-->"
...
var EditproductComponent = /** @class */ (function () {
    function EditproductComponent(service, activateRoute, formBuilder) {
        this.service = service;
        ...
        this.myGroup = formBuilder.group({
            ...
            image1: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            image2: [''],
            image3: [''],
            image4: [''],
            image5: [''],
            ...
            image8: [''],
            imageArray: this.formBuilder.array([]),
            productcategory: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            productsubcategory: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            producttype: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            productbrand: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            // addBrand: [''],
            searchtag: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            // combinationOfVariants: [''],
            sellingprice: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern('^[0-9]*$')])],
            costprice: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern('^[0-9]*$')])],
            itemweight: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern('^[0-9]*$')])],
            InventorySKU: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            ...
            trialPack: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            // brand: [''],
            variance: this.formBuilder.array([])
        });
    }
    EditproductComponent.prototype.ngOnInit = function () {
        ...
        this.service.setTitle('Edit Product');
        this.getCategoryList();
        console.log("this.productDetail.product.description", this.productDetail);
        // this.ckeditorContent=this.productDetail.description
    };
    EditproductComponent.prototype.createItem = function (item) {
        return this.formBuilder.group({
            size: [item.size],
            color: [item.color],
            material: [item.material],
            checked: [true],
            price: [item.price, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern('^[0-9]*$')])],
            SKU: [item.SKU],
            quantity: [item.quantity, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern('^[0-9]*$')])],
            image: [item.image, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required]
        });
    };
    // createImageArray(item): FormGroup {
    //   return this.formBuilder.group({
    //     size: [item.size],
    //     color: [item.color],
    //     material: [item.material],
    //     checked: [true],
    //     price: [item.price, Validators.compose([Validators.required, Validators.pattern('^[0-9]*$')])],
    //     SKU: [item.SKU],
    //     quantity: [item.quantity, Validators.compose([Validators.required, Validators.pattern('^[0-9]*$')])],
    //     varianceImage: [item.image, Validators.required]
    //   });
    // }
    //!api called
    EditproductComponent.prototype.getProductDetail = function () {
        ...
        this.activateRoute.params.subscribe(function (params) {
            _this._id = params['productId'];
            // console.log(`vendor/productDetails?_id=${this._id}&lang=en`)
        });
        this.service.getApi("vendor/getProductInfo?productId=" + this._id + "&lang=en", 0).subscribe(function (response) {
            // console.log(response)
            if (response['statusCode'] == 200) {
                _this.service.showSuccess("get Product Detail");
                _this.productDetail = response['result'];
                console.log('8888888888888888888888888', _this.productDetail);
                _this.categoryId = _this.productDetail.categoryModel;
                _this.productsubcategory = _this.productDetail.subCategory;
                _this.producttype = _this.productDetail.productCategoryId;
                _this.branddata = _this.productDetail.brandId;
                _this.myGroup.patchValue({
                    title: _this.productDetail.productName,
                    description: _this.productDetail.description,
                    // image1:this.productDetail.image[0],
                    productcategory: _this.productDetail.categoryModel._id,
                    productsubcategory: _this.productDetail.subCategory._id,
                    producttype: _this.productDetail.productCategoryId._id,
                    productbrand: _this.productDetail.brandId._id,
                    // addBrand: ,
                    searchtag: _this.productDetail.tag,
                    // combinationOfVariants: ,
                    sellingprice: _this.productDetail.sellingPrice,
                    costprice: _this.productDetail.costItem,
                    itemweight: _this.productDetail.weight,
                    InventorySKU: _this.productDetail.inventorySKU,
                    quantity: _this.productDetail.quantity,
                });
                _this.getSubCatoryList(_this.categoryId._id);
                _this.getProductName(_this.productsubcategory._id);
                _this.getBrandListdata();
                for (var i = 0; i < _this.productDetail.varianceId.variants.length; i++) {
                    _this.addItem(_this.productDetail.varianceId.variants[i]);
                }
                for (var index = 0; index < _this.productDetail.image.length; index++) {
                    console.log('------', _this.productDetail.image[index]);
                    // console.log("this form group",this.myGroup.value.imageArray.push("asdf"))
                    _this.myGroup.value.imageArray.push(_this.productDetail.image[index]);
                    // let a =[]
                    // a.push(this.productDetail.image[index])
                    // const steps = <FormArray>this.myGroup.controls['imageArray'];
                    // steps.push(new FormControl(this.myGroup.get('imageArray').setValue("sumit")))
                    // this.myGroup.get('imageArray').setValue('22222')
                    // this.myGroup.controls['variance'].controls[i].controls['varianceImage'].setValue(a)
                    // steps.push(new FormControl()) 
                }
                // const control = <FormArray>this.myGroup.controls['imageArray'];
                // control.push(this.initlanguage());
            }
            else {
                console.log(response['result']);
    ...
    // onFileChanged
    EditproductComponent.prototype.onFileChanged = function (evt) {
        var file = evt.target.files[0];
        if (file) {
            // console.log('2222', file);
            var reader = new FileReader();
    ...
    EditproductComponent.prototype.handleReaderLoaded = function (e) {
        this.imageData.push('data:image/png;base64,' + btoa(e.target.result));
    };
    EditproductComponent.prototype.addItem = function (item) {
        // debugger
        this.items = this.myGroup.get('variance');
        this.items.push(this.createItem(item));
    };
    //dropdown data 
    EditproductComponent.prototype.getCatgory = function (categoryId) {
        // console.log("Event-->", categoryId);
        this.getSubCatoryList(categoryId);
        this.getBrandListdata();
    };
    EditproductComponent.prototype.SubCatorydata = function (subcategoryId) {
        // console.log("Event------------>", subcategoryId);
        this.subCategoryID = subcategoryId;
        this.getProductName(subcategoryId);
        // console.log("data is binding-------->",this.itemsAsObjects)
    };
    EditproductComponent.prototype.getCategoryList = function () {
        var _this = this;
        this.service.getApi('vendor/getCategoryList', 0).subscribe(function (response) {
            if (response['statusCode'] == 200) {
                // this.service.showSuccess('found')
                _this.category = response['result'];
                // this.getSubCatoryList(this.categoryId._id)
            }
            else {
                _this.service.showError('Invalid Email');
                // this.service.showError('Invalid email or password.')
    ...
    EditproductComponent.prototype.getSubCatoryList = function (categoryId) {
        var _this = this;
        // console.log("function called")
        var postSubCatory = {
            categoryModel: categoryId,
        ...
        this.service.postApi('vendor/getSubCategory', postSubCatory, 0).subscribe(function (response) {
            if (response['statusCode'] == 200) {
                // this.service.showSuccess('data is find')
                _this.getSubCatorydata = response['result'];
            }
    ...
    EditproductComponent.prototype.getProductName = function (subCatId) {
        var _this = this;
        var temp = {
            subCategoryId: subCatId
        };
    ...
    EditproductComponent.prototype.getBrandListdata = function () {
        var _this = this;
        // console.log("function called")
        this.service.getApi('admin/getBrandList', 0).subscribe(function (response) {
            if (response['statusCode'] == 200) {
                // this.service.showSuccess("get bandlist")
                // console.log("asdfasdf", response)
                _this.getBrandId = response['result'];
            }
            else {
                _this.service.showError('Invalid Email');
                // this.service.showError('Invalid email or password.')
    ...
    EditproductComponent.prototype.getProductCategoryId = function (_ID) {
        console.log("getProductlist enter", _ID);
        // this.productCategoryname = _ID
    };
    EditproductComponent.prototype.saveProduct = function (val) {
        var _this = this;
        // console.log('save product==>', val)
        // console.log("aw323451234513453245", this.imageData)
        // return
        // return
        var temp = {
            productId: this._id,
            categoryModel: val.productcategory,
            subCategory: val.productsubcategory,
            productCategoryId: val.producttype,
            brandId: val.productbrand,
            productName: val.title,
            sellingPrice: val.sellingPrice,
            ...
            image: val.imageArray,
            tag: val.searchtag,
            tryImage: val.tryImage ? val.tryImage : null,
        ...
        console.log('temp------>>', JSON.stringify(temp));
        // return
        this.service.postApi('vendor/editProduct', temp, 0).subscribe(function (response) {
            console.log(response);
            if (response['statusCode'] == 200) {
                _this.service.showSuccess(response['statusMessage']);
            }
    ...
    EditproductComponent.prototype.removeImage = function (val) {
        console.log('345678987656789o0987654', val);
        var control = this.myGroup.controls['imageArray'];
        console.log("1", control.value);
        control.value.splice(val - 1, 1);
    ...
    EditproductComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_Services_provider_service__WEBPACK_IMPORTED_MODULE_1__["DataService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"]])
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_app_Services_provider_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/Services/provider.service */ "./src/app/Services/provider.service.ts");
/* harmony import */ var _Components_constant_app_constant__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../Components/constant/app.constant */ "./src/app/Components/constant/app.constant.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePageVendorComponent = /** @class */ (function () {
    function HomePageVendorComponent(service) {
        ...
        this.rows = [];
        this.selected = [];
        this.appconstant = _Components_constant_app_constant__WEBPACK_IMPORTED_MODULE_2__["appConstant"];
        this.pieChartLabels = ['OpenOrder', 'Dispatch', 'Pending'];
        this.pieChartData = [234, 500, 100];
    ...
    // events
    HomePageVendorComponent.prototype.chartClicked = function (e) {
        console.log(e);
    };
    HomePageVendorComponent.prototype.chartHovered = function (e) {
        console.log(e);
    };
    ...
    HomePageVendorComponent.prototype.getDashboadData = function () {
        var _this = this;
        this.service.spinnerShow();
        console.log("vendor/dashBoardForVendor?/lang=" + this.appconstant['lang']);
        this.service.getApi("vendor/dashBoardForVendor?/lang=" + this.appconstant['lang'], 1).subscribe(function (response) {
            console.log("response--->>", response);
            if (response['statusCode'] == 200) {
                _this.service.spinnerHide();
                _this.dashBoard = response['result'];
                _this.openOrder = response['result']['openOrder'];
                _this.pieChartData = [_this.openOrder, 500, 100];
            }
            else {
                _this.service.showError(response['statusMessage']);
            }
            ...
            console.log('error occur', error);
            _this.service.showError('Servedddr Error');
        });
    };
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _Components_constant_app_constant__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../Components/constant/app.constant */ "./src/app/Components/constant/app.constant.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var WakiLoginComponent = /** @class */ (function () {
    function WakiLoginComponent(formBuilder, route, service) {
        ...
        this.service = service;
        this.isValid = true;
        this.appconstant = _Components_constant_app_constant__WEBPACK_IMPORTED_MODULE_4__["appConstant"];
        this.formgroup = formBuilder.group({
    ...
    WakiLoginComponent.prototype.login = function (val) {
        ...
        var logindata = {
            ...
            "lang": this.appconstant['lang'],
            "userType": this.appconstant['userType']
        };
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getCountryCodeJson = function () {
        return this.http.get('assets/json/countryCodes.json');
    };
    DataService.prototype.getCountryCJson = function () {
...
/* harmony import */ var _Components_create_vendor_create_vendor_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./Components/create-vendor/create-vendor.component */ "./src/app/Components/create-vendor/create-vendor.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    { path: 'editProduct/:productId', component: _Components_editproduct_editproduct_component__WEBPACK_IMPORTED_MODULE_7__["EditproductComponent"] },
    ...
    { path: 'createvendor', component: _Components_create_vendor_create_vendor_component__WEBPACK_IMPORTED_MODULE_23__["CreateVendorComponent"] },
    { path: '**', component: _Components_home_page_vendor_home_page_vendor_component__WEBPACK_IMPORTED_MODULE_4__["HomePageVendorComponent"] },
];
...
/* harmony import */ var _Components_create_vendor_create_vendor_component__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(/*! ./Components/create-vendor/create-vendor.component */ "./src/app/Components/create-vendor/create-vendor.component.ts");
/* harmony import */ var ng2_charts__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(/*! ng2-charts */ "./node_modules/ng2-charts/index.js");
/* harmony import */ var ng2_charts__WEBPACK_IMPORTED_MODULE_50___default = /*#__PURE__*/__webpack_require__.n(ng2_charts__WEBPACK_IMPORTED_MODULE_50__);
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _Components_create_vendor_create_vendor_component__WEBPACK_IMPORTED_MODULE_49__["CreateVendorComponent"],
            ],
            imports: [
                ...
                ng2_charts__WEBPACK_IMPORTED_MODULE_50__["ChartsModule"]
                // NgDatepickerModule
            ],
            entryComponents: [
                _Components_child_child_component__WEBPACK_IMPORTED_MODULE_28__["ChildComponent"]
